...
namespace Nart
{
    ...
    public class ModelSettingItem : ObservableObject
    {
        ...
        //{
        //    //ModelGeometry已經有幾何模型存在內部 及 阻擋檔案不存在的情況
        //    if (OSP2.IsLoaded || !System.IO.File.Exists(OSPFilePath))
        //    {
        //        return;
        //    }
        ...
        //    OSP2.ModelContainer = reader.Read(OSPFilePath);
            
        //    var geometryModel = OSP2.ModelContainer.Children[0] as System.Windows.Media.Media3D.GeometryModel3D;
        ...
        //    OSP2.OSPOriNormal = new Vector3D(mesh.Normals[0].X, mesh.Normals[0].Y, mesh.Normals[0].Z);
        //    OSP2.OSPOriNormal.Normalize();//將上述向量正規化
        //    OSP2.OSPPlanePoint  = mesh.Positions[0];
        //    //設定模型材質
        //    SetOSPMaterial();
        ...
        //    //else
        //    //{
        //    OSP2.Geometry = ospGeometry;
        //    //}
        //    OSP2.Transform = new MatrixTransform3D();
